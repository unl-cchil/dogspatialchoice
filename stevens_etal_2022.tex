...
{\centering \includegraphics[width=0.8\linewidth]{/media/jstevens/data/jstevens/OneDrive/active_sync/projects/dogspatialchoice/figures/setup_study} 
...
Dogs traveled a mean \(\pm\) SD distance of 1.69 m \(\pm\) 1.10 m (range: 0.25 \negthickspace \(-\) \negthickspace 4.25 m) in Study 1 and 1.81 m \(\pm\) 0.81 m (range: 0.50 \negthickspace \(-\) \negthickspace 4.50 m) in Study 2 (Figure \ref{fig:study-comp}a). The mean \(\pm\) SD overall Dog Impulsivity Assessment Scale (DIAS) scores were 0.48 \(\pm\) 0.09 (range: 0.31 \negthickspace \(-\) \negthickspace 0.70) in Study 1 and 0.47 \(\pm\) 0.06 (range: 0.36 \negthickspace \(-\) \negthickspace 0.63) in Study 2 (Figure \ref{fig:study-comp}b).

\begin{figure*}

{\centering \includegraphics[width=1\linewidth]{/media/jstevens/data/jstevens/OneDrive/active_sync/projects/dogspatialchoice/figures/study_comparison} 
...
{\centering \includegraphics[width=1\linewidth]{/media/jstevens/data/jstevens/OneDrive/active_sync/projects/dogspatialchoice/figures/distance_dias_overall} 
...
{\centering \includegraphics[width=1\linewidth]{/media/jstevens/data/jstevens/OneDrive/active_sync/projects/dogspatialchoice/figures/forestplot_bf} 
