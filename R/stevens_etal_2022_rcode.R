...
all_data <- read_csv(here("data/stevens_etal_2022_data1.csv")) %>% 
...
item_data <- read_csv(here("data/stevens_etal_2022_data2.csv"))
...
ggsave(here("figures/distance_dias_overall.png"), width = 10, height = 5)
...
ggsave(here("figures/distance_dias_subscales.png"), width = 10, height = 15)
...
dog_sex_plot + dog_weight_plot + dog_age_plot + dog_akc_plot +
  plot_layout(ncol = 2) +
  plot_annotation(tag_levels = "a", tag_suffix = ")", tag_prefix = "(")
ggsave(here("figures/dog_characteristics.png"), width = 10, height = 10)
...
disobedience_plot + aggression_plot + destructive_plot + 
  ...
  plot_layout(ncol = 3) +
  plot_annotation(tag_levels = "a", tag_suffix = ")", tag_prefix = "(")
ggsave(here("figures/dog_behavior.png"), width = 10, height = 10)
...
(mdors_plot + extraversion_plot + aggreeable_plot + 
  ...
  plot_layout(ncol = 3) +
  plot_annotation(tag_levels = "a", tag_suffix = ")", tag_prefix = "(")
ggsave(here("figures/owner_characteristics.png"), width = 10, height = 10)
...
ggsave(here("figures/study_comparison.png"), width = 10, height = 4, scale = 1.2)
...
ggsave(here("figures/forestplot_bf.png"), width = 9, height = 4)
...
save.image(here("dog_spatial_workspace.RData"))
